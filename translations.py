...
BASIC_TRANSLATIONS = {
    ...
    'ny': {
        'Welcome to Ulimi Wise': 'Takulandirani ku Ulimi Wise',
        'Login': 'Lowani',
        'Register': 'Lembetsani',
        'Logout': 'Tulukani',
        'Dashboard': 'Dashbodi',
        'Marketplace': 'Msika',
        'Farming Tips': 'Malangizo a Ulimi',
        'Agricultural News': 'Nkhani za Ulimi',
        'My Profile': 'Mbiri Yanga',
        'Agricultural Assistant': 'Wothandiza wa Ulimi',
        'Weather': 'Nyengo',
        'Language': 'Chilankhulo',
        'Search': 'Sakani',
        'Products': 'Zokolola',
        'Add Product': 'Onjezani Zokolola',
        'Category': 'Mtundu',
        'Price': 'Mtengo',
        'Quantity': 'Kuchuluka',
        'Seller': 'Ogulitsa',
        ...
        'Email': 'Imelo',
        'Password': 'Achinsinsi',
        'Confirm Password': 'Tsimikizani Achinsinsi',
        'Location': 'Malo',
        'Farm Type': 'Mtundu wa Munda',
        'Current Weather': 'Nyengo Yamakono',
        'Temperature': 'Kutentha',
        'Humidity': 'Chinyontho',
        'Wind': 'Mphepo',
        'Conditions': 'Mkhalidwe',
        'News': 'Nkhani',
        'Videos': 'Mavidiyo',
        'Podcasts': 'Mapodikasiti',
        'Articles': 'Nkhani',
        'Read More': 'Werengani Zambiri',
        'Watch': 'Onani',
        'Listen': 'Mverani',
        'No results found': 'Palibe zotsatira zapezeka',
        'Loading...': 'Kukweza...',
        'Type your message here...': 'Lembani uthenga wanu pano...',
        'Send': 'Tumizani',
        'Speak': 'Lankhulani',
        'Invalid email or password': 'Imelo kapena achinsinsi olakwika',
        'Registration successful! Please login.': 'Kulembetsa kwachita bwino! Chonde lowani.',
        'Profile updated successfully': 'Mbiri yasinthidwa bwino',
        'Product added successfully': 'Chokolola chawonjezedwa bwino',
        'Product updated successfully': 'Chokolola chasinthidwa bwino',
        'Product deleted successfully': 'Chokolola chafufumizidwa bwino',
        'Invalid email format': 'Imelo yolakwika',
        'Username or email already in use': 'Dzina lolowera kapena imelo kale likugwiritsidwa ntchito',
        'All fields marked with * are required': 'Madera onse osonyezedwa ndi * akufunika',
        'Price and quantity must be numeric values': 'Mtengo ndi kuchuluka ziyenera kukhala manambala',
        'You can only update your own products': 'Mungathe kusintha zinthu zanu zokha',
        'You can only delete your own products': 'Mungathe kufufumiza zinthu zanu zokha',
        'Current password is incorrect': 'Achinsinsi amakono ndi olakwika',
        'No message provided': 'Palibe uthenga woperekedwa',
        'No text provided': 'Palibe mawu operekedwa',
        'No location provided': 'Palibe malo operekedwa',
        'Weather data is not available. Please check your location settings.': 'Chidziwitso cha nyengo sichipezeka. Chonde onetsetsani zoikika za malo anu.'
    }
}
